%	READ_SYN_BF_FILE Reads in a file of beamforming feedback logs.
%	The difference between read_syn_bf_file and read_bf_file is that read_syn_bf_file have a 64 bit high-precision(us) timestamp.
%   This version uses the *C* version of read_syn_bfee, compiled with
%   MATLAB's MEX utility.
%
% (c) 2019 Wang Zhixiang <2856193308@qq.com>
%
function ret = read_syn_bf_file(filename)
%% Input check
